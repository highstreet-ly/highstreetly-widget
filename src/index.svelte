...
<script>
  ...
  onMount(() => {
    ...
    mapsNode.src =
      "https://maps.googleapis.com/maps/api/js?key=AIzaSyABLPTFGd4Y-0VB0RCM8Wcbvvkm79HOdSo&libraries=places";
    ...
    var _rollbarConfig = {
      accessToken: "33dba0ddc3db42af9183967cd959ab95",
      ...
      function (r, e, o) {
        ...
        (_rollbarConfig = _rollbarConfig || {}),
          (_rollbarConfig.rollbarJsUrl =
            _rollbarConfig.rollbarJsUrl ||
            "https://cdn.rollbar.com/rollbarjs/refs/tags/v2.21.0/rollbar.min.js"),
